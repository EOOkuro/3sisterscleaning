...
const CartoonGirl2 = ({ className = '', size = 300 }) => {
  return (
    <motion.div
    ...
    >
      ...
      >
        {/* Background Circle */}
        <circle cx="150" cy="150" r="140" fill="url(#bgGradient2)" opacity="0.2" />
        
        {/* Body */}
        <ellipse cx="150" cy="220" rx="45" ry="55" fill="url(#bodyGradient2)" />
        ...
        {/* Hair - Top */}
        <ellipse cx="150" cy="95" rx="55" ry="45" fill="url(#hairGradient2)" />
        ...
        {/* Blush - Left */}
        <ellipse cx="115" cy="145" rx="12" ry="8" fill="#FDBA74" opacity="0.5" />
        
        {/* Blush - Right */}
        <ellipse cx="185" cy="145" rx="12" ry="8" fill="#FDBA74" opacity="0.5" />
